...
import com.poojabhagat.Lovable_clone.repository.UsageLogRepository;
...
public class UsageServiceImpl implements UsageService {
    ...
    public void recordTokenUsage(Long userId, int actualTokens) {
        ...
        UsageLog todayLog = usageLogRepository.findByUserIdAndDate(userId, today).orElseGet(
                () -> createNewDailyLog(userId, today));
