...
import com.poojabhagat.Lovable_clone.dto.subscription.CheckoutRequest;
import com.poojabhagat.Lovable_clone.dto.subscription.CheckoutResponse;
import com.poojabhagat.Lovable_clone.dto.subscription.PortalResponse;
...
import com.poojabhagat.Lovable_clone.error.BadRequestException;
import com.poojabhagat.Lovable_clone.error.ResourceNotFoundException;
import com.poojabhagat.Lovable_clone.repository.PlanRepository;
import com.poojabhagat.Lovable_clone.repository.UserRepository;
import com.poojabhagat.Lovable_clone.security.AuthUtil;
import com.poojabhagat.Lovable_clone.service.PaymentProcessor;
import com.poojabhagat.Lovable_clone.service.SubscriptionService;
...
public class StripePaymentProcessor implements PaymentProcessor {
    ...
    public CheckoutResponse createCheckoutSessionUrl(CheckoutRequest request) {
        ...
        var params = SessionCreateParams.builder()
                ...
                .setSuccessUrl(frontendUrl + "/sucesss.html?session_id={CHECKOUT_SESSION_ID}")
    ...
    public PortalResponse openCustomerPortal() {
        ...
        if(stripeCustomerId == null || stripeCustomerId.isEmpty()) {
            throw new BadRequestException("User does not have a Stripe Customer Id, User:" + userId);
        }
